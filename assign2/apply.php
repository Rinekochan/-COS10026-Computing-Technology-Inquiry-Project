...
<body id = "ApplyMainBackground">
    ...
    <form method="post" action="processEOI.php" novalidate="novalidate">
        <section class="center">
            ...
            <div class="formBox">
                <label for="ReferenceNumber">Reference number<span class = "asterisks">*</span></label>
            ...
            <div class="formBox">
                <label for="FirstName">First name<span class = "asterisks">*</span></label>
            ...
            <div class="formBox">
                <label for="LastName">Last name<span class = "asterisks">*</span></label>
            ...
            <div class="formBox">
                <label for="DOB">Date of Birth<span class = "asterisks">*</span></label>
            ...
            <fieldset class="blueApply">
                ...
                <div class="formBox">
                    <label for="StreetAddress">Street Address<span class = "asterisks">*</span></label>
                ...
                <div class="formBox">
                    <label for="Suburb">Suburb/Town<span class = "asterisks">*</span></label>
                    <input type="text" id="Suburb" name="Suburb" required="required" pattern="[A-Za-z0-9\s]{1,40}" placeholder="Enter Suburb/Town">
                    <span></span>
                </div>
                <!-- State Selection -->
                <div class="formBox">
                ...
                <div class="formBox">
                    ...
                    <input type="text" id="Postcode" name="Postcode" required="required" maxlength="4" pattern="[0-9]{4}" placeholder="Postal Code">
                    <span></span>
                </div>
            </fieldset>
            <br>
            <fieldset class="greenApply">
                ...
                <!-- Email Text Input -->
                <div class="formBox">
                    <label for="Email">Email Address<span class = "asterisks">*</span></label>
                    <input type="email" id="Email" name="Email" required="required" placeholder="Enter Email">
                    <span></span>
                </div>
                <!-- Phone Number Text Input -->
                <div class="formBox">
                    <label for="PhoneNumber">Phone Number<span class = "asterisks">*</span></label>
